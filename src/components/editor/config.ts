...
<html lang="en">
  ...
  <body>
    <div class="overflow-hidden text-[#07474e]">
        ...
        >
          ...
          >
            <a class="text-[42px] font-black mw500:text-[42px]" href="/"
              >APES</a
            >
            <p class="text-base font-semibold leading-[18px] mw500:text-[11px]">
          ...
          <div class="flex gap-3">
            <div class="flex gap-3">
              ...
              ><a
                ...
                rel="noopener noreferrer"
                class="bg-white w-[52px] h-[52px] grid place-items-center rounded-full"
                ><img class="mr-[3px]" src="/asset/telegram.svg" alt="telegram"
              /></a>
            </div>
            <button
      ...
      <main>
              ...
              >
                ...
                ><a
                  ...
                  ><button
                    class="bg-[#FFEA2D] w-full font-extrabold text-base py-[10px] px-4 shadow-[0_4px_0_0_#e7b400] rounded-xl transition-opacity hover:opacity-90 flex items-center justify-center gap-[2px]"
                  >
                    <img src="/asset/cg.png" alt="CoinGecko" class="w-7 h-7" />
                    <p>COINGECKO</p>
                  </button></a
                >
              </div>
              ...
              <div class="slick-list">
                ...
                >
                  ...
                  >
                    <div>
                      <div
                        class="h-[121px] w-[220px] rounded-xl bg-[#EBF6F7]"
                        tabindex="-1"
                  ...
                  <div
                    ...
                    tabindex="-1"
                    aria-hidden="false"
                    style="outline: none; width: 206px"
                  >
                    <div>
                      <div
                        class="h-[121px] w-[220px] rounded-xl bg-[#EBF6F7]"
        ...
        >
          ...
          >
            ...
            >
              <img
                class="min-w-[688px] mw1000:min-w-[463px] mw300:min-w-[150px] pointer-events-none"
                width="446"
                height="700"
            ...
            <div class="max-w-[543px] mw600:px-4">
              ...
              <div class="flex gap-3 mb-3">
                ...
                >
                  ...
                  <p class="font-extrabold text-3xl mw600:text-xl">Billion!</p>
                </div>
                <div
                  class="flex flex-col gap-2 text-center bg-white rounded-xl p-7 w-full mw600:p-3"
                >
